														...
														success : function(
															...
															$(
																	...
																	.val(
																			result.id);
															$(
																	'#editEmployeeModal #name')
																	.val(
																			result.name);
															$(
																	'#editEmployeeModal #email')
																	.val(
																			result.email);
															$(
																	'#editEmployeeModal #phone')
																	.val(
																			result.phone);
														}
													});
...
<body>
	<div class="container">
		<div class="table-wrapper">
					...
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success"
							data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add
								New Employee</span></a> <a href="#deletelistEmployeeModal" id="check"
			...
			<form id="form"
				action="${pageContext.request.contextPath }/user?action=deleteList"
				method="post">
						...
						<c:forEach var="user" items="${users}" varStatus="i">
							<tr>
								<td><span class="custom-checkbox"> <input
										type="checkbox" name="ids" id="myCheck" value="${user.id }">
				...
				<ul class="pagination">
					<c:if test="${tag>1}">
						<li class="page-item "><a
							href="${pageContext.request.contextPath}/user?index=${tag-1}">Previous</a></li>
					</c:if>
					...
					<c:if test="${tag<endP}">
						<li class="page-item"><a
							href="${pageContext.request.contextPath}/user?index=${tag+1}"
	...
	<div id="deleteEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form method="post"
					action="${pageContext.request.contextPath }/user?action=delete">
					<div class="modal-header">
	...
	<!-- Delete List Modal HTML -->
	<div id="deletelistEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<input type="button" class="btn btn-default" data-dismiss="modal"
						value="Cancel"> <input type="submit" form="form"
